      ...
      <div className="container mt-5">
        <div className="text-center mb-4">
          ...
          <p className="lead text-secondary">
            Join our network of mental health professionals. Fill out the form to apply as a counselor.
          </p>
        </div>
        ...
        >
          <h2 className="text-center mb-4 text-primary">Counselor Application Form</h2>
