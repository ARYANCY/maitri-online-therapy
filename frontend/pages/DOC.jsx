...
const defaultTherapistForm = {
  ...
  dateOfBirth: "",
  location: "",
  timeZone: "", // Empty by default - user must select
  email: "",
            ...
            <div className="doc-form-content">
              ...
              <form onSubmit={handleHealthcareSubmit}>
                    ...
                    <div className="row g-4">
                      ...
                      <div className="col-md-8">
                        <div className="row g-3">
                          ...
                          <div className="col-md-6">
                            <label className="doc-form-label">Gender</label>
                            <select className="form-select doc-form-input" name="gender" value={healthcareFormData.gender} onChange={handleHealthcareChange}>
                          ...
                          <div className="col-md-6">
                            <label className="doc-form-label">Pronouns</label>
                            <select className="form-select doc-form-input" name="pronouns" value={healthcareFormData.pronouns} onChange={handleHealthcareChange}>
                              <option value="He/Him">He/Him</option>
                              <option value="She/Her">She/Her</option>
                              <option value="They/Them">They/Them</option>
                              <option value="Other">Other</option>
                          ...
                          <div className="col-md-6">
                            ...
                            <input type="tel" className="form-control doc-form-input" name="phone" value={healthcareFormData.phone} onChange={handleHealthcareChange} placeholder="+91 9876543210" />
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="col-12">
                        <label className="doc-form-label">Emergency Contact (Optional)</label>
                        <div className="row g-3">
                          <div className="col-md-4">
                            <input type="text" className="form-control doc-form-input" name="emergencyContact.name" value={healthcareFormData.emergencyContact.name} onChange={handleHealthcareChange} placeholder="Contact Name" />
                          </div>
                          <div className="col-md-4">
                            <input type="tel" className="form-control doc-form-input" name="emergencyContact.phone" value={healthcareFormData.emergencyContact.phone} onChange={handleHealthcareChange} placeholder="Contact Phone" />
                          </div>
                          <div className="col-md-4">
                            <input type="text" className="form-control doc-form-input" name="emergencyContact.relationship" value={healthcareFormData.emergencyContact.relationship} onChange={handleHealthcareChange} placeholder="Relationship" />
                          </div>
                        </div>
                      </div>
                    </div>
                ...
                {hcCurrentStep === 2 && (
                  <div className="doc-step-content animate-fade-in">
                    <div className="doc-section-header">
                      <h3><i className="bi bi-briefcase-fill me-2"></i>Role Type</h3>
                      <p>Select your professional role(s) in dementia care. You can select multiple.</p>
                    </div>
                    ...
                    <div className="row g-4">
                      ...
                      <div className="col-12">
                        <label className="doc-form-label">Short Bio</label>
                        <textarea className="form-control doc-form-input" name="shortBio" value={healthcareFormData.shortBio} onChange={handleHealthcareChange} rows="4" placeholder="Describe your experience in dementia care, your approach, and what motivates you..." maxLength={1500}></textarea>
                      ...
                      <div className="col-md-6">
                        ...
                        <div className="input-group mb-2">
                          <input type="text" className="form-control doc-form-input" value={newSkill} onChange={(e) => setNewSkill(e.target.value)} placeholder="e.g., Cognitive Stimulation" />
                        ...
                        <div className="tag-list">
                          {healthcareFormData.specialSkills.map((skill, idx) => (
                            <span key={idx} className="tag tag-success">{skill} <button type="button" className="tag-remove" onClick={() => setHealthcareFormData(prev => ({ ...prev, specialSkills: prev.specialSkills.filter((_, i) => i !== idx) }))}>&times;</button></span>
                          ))}
                        </div>
                      </div>
                    </div>
                ...
                {hcCurrentStep === 3 && (
                  <div className="doc-step-content animate-fade-in">
                    <div className="doc-section-header">
                      <h3><i className="bi bi-award me-2"></i>Professional Credentials</h3>
                      <p>Your qualifications and certifications for dementia care.</p>
                    </div>

                    <div className="row g-4">
                      <div className="col-md-6">
                        <label className="doc-form-label">Highest Qualification <span className="text-danger">*</span></label>
                        <input type="text" className="form-control doc-form-input" name="highestQualification" value={healthcareFormData.highestQualification} onChange={handleHealthcareChange} placeholder="MBBS, MD Neurology, etc." required />
                      </div>
                      <div className="col-md-6">
                      ...
                      <div className="col-md-6">
                        <label className="doc-form-label">License/Registration Number</label>
                        <input type="text" className="form-control doc-form-input" name="licenseNumber" value={healthcareFormData.licenseNumber} onChange={handleHealthcareChange} placeholder="MCI/XXX/XXXX" />
                      </div>

                      <div className="col-12">
                        <label className="doc-form-label">Dementia-Specific Certifications</label>
                        <div className="card doc-inner-card">
                          <div className="card-body">
                            <div className="row g-2 mb-3">
                              <div className="col-md-4">
                      ...
                      <div className="col-12">
                        <label className="doc-form-label">Upload Certificates & Credentials</label>
                        <div className="file-upload-area">
                          <label className="file-upload-label">
                            {uploadingCerts ? (
                              <span className="spinner-border spinner-border-sm me-2"></span>
                            ...
                            Click to upload (JPG, PNG only - Max 5 files)
                      ...
                      <div className="col-12">
                        <label className="doc-form-label">Previous Institutions / Care Homes</label>
                        <div className="card doc-inner-card">
                          <div className="card-body">
                            <div className="row g-2 mb-3">
                              <div className="col-md-3">
                                <input type="text" className="form-control doc-form-input" placeholder="Institution Name" value={newInstitution.name} onChange={(e) => setNewInstitution({ ...newInstitution, name: e.target.value })} />
                              </div>
                              <div className="col-md-3">
                                <input type="text" className="form-control doc-form-input" placeholder="Role" value={newInstitution.role} onChange={(e) => setNewInstitution({ ...newInstitution, role: e.target.value })} />
                              </div>
                              <div className="col-md-2">
                                <input type="text" className="form-control doc-form-input" placeholder="Duration" value={newInstitution.duration} onChange={(e) => setNewInstitution({ ...newInstitution, duration: e.target.value })} />
                              </div>
                              <div className="col-md-2">
                                <input type="text" className="form-control doc-form-input" placeholder="Location" value={newInstitution.location} onChange={(e) => setNewInstitution({ ...newInstitution, location: e.target.value })} />
                              </div>
                              <div className="col-md-2">
                                <button type="button" className="btn btn-primary w-100" onClick={addInstitution}>
                                  <i className="bi bi-plus-lg"></i>
                                </button>
                              </div>
                            </div>
                            {healthcareFormData.previousInstitutions.length > 0 && (
                              <div className="cert-list">
                                {healthcareFormData.previousInstitutions.map((inst, idx) => (
                                  <div key={idx} className="cert-item d-flex justify-content-between align-items-center">
                                    <span><strong>{inst.name}</strong> - {inst.role} {inst.duration && `(${inst.duration})`} {inst.location && `@ ${inst.location}`}</span>
                                    <button type="button" className="btn btn-sm btn-outline-danger" onClick={() => setHealthcareFormData(prev => ({ ...prev, previousInstitutions: prev.previousInstitutions.filter((_, i) => i !== idx) }))}>
                                      <i className="bi bi-x"></i>
                                    </button>
                                  </div>
                                ))}
                ...
                {hcCurrentStep === 4 && (
                  <div className="doc-step-content animate-fade-in">
                    <div className="doc-section-header">
                      <h3><i className="bi bi-clipboard2-pulse me-2"></i>Experience with Dementia Types</h3>
                      <p>Select the dementia types and stages you have experience handling.</p>
                    </div>
                    ...
                    <div className="row g-4">
                      ...
                      <div className="col-12">
                        <label className="doc-form-label">Dementia Stages You Handle</label>
                        <div className="multi-select-grid">
                        ...
                        <div className="d-flex flex-wrap gap-2">
                          {HC_COMMUNICATION_MODES.map((mode) => (
                            <button key={mode} type="button" className={`btn btn-sm ${healthcareFormData.preferredCommunicationMode.includes(mode) ? 'btn-primary' : 'btn-outline-primary'}`} onClick={() => handleHcMultiSelect('preferredCommunicationMode', mode)}>
                              <i className={`bi bi-${mode === 'Video' ? 'camera-video' : mode === 'Audio' ? 'telephone' : mode === 'Chat' ? 'chat-dots' : mode === 'Home Visit' ? 'house-door' : 'geo-alt'} me-1`}></i>
                              {mode}
                            </button>
                          ))}
                        </div>
                      ...
                      <div className="col-12">
                        ...
                        <div className="row g-3">
                          ...
                          <div className="col-md-4">
                            ...
                            <small className="text-muted">Follow-up Visit</small>
                          </div>
                          <div className="col-md-4">
                            <div className="input-group">
                              <span className="input-group-text">₹</span>
                      ...
                      <div className="col-md-6">
                        <div className="form-check form-switch">
                          <input className="form-check-input" type="checkbox" name="acceptsInsurance" checked={healthcareFormData.acceptsInsurance} onChange={handleHealthcareChange} />
                          <label className="form-check-label">Accept Insurance?</label>
                        </div>
                      </div>

                      {healthcareFormData.acceptsInsurance && (
                        <div className="col-md-6">
                          <label className="doc-form-label">Insurance Providers</label>
                          <div className="input-group mb-2">
                            <input type="text" className="form-control doc-form-input" value={newInsuranceProvider} onChange={(e) => setNewInsuranceProvider(e.target.value)} placeholder="Add provider" />
                            <button type="button" className="btn btn-outline-primary" onClick={addInsuranceProvider}>Add</button>
                          </div>
                          <div className="tag-list">
                            {healthcareFormData.insuranceProviders.map((provider, idx) => (
                              <span key={idx} className="tag tag-primary">{provider} <button type="button" className="tag-remove" onClick={() => setHealthcareFormData(prev => ({ ...prev, insuranceProviders: prev.insuranceProviders.filter((_, i) => i !== idx) }))}>&times;</button></span>
                            ))}
                          </div>
                        </div>
                      )}
                        ...
                        <div className="card doc-inner-card">
                          <div className="card-body">
                            <div className="row g-3 mb-3">
                              <div className="col-md-4">
                                <label className="doc-form-label">Date</label>
                                <input type="date" className="form-control doc-form-input" value={healthcareAvailabilityDate} onChange={e => setHealthcareAvailabilityDate(e.target.value)} min={new Date().toISOString().split('T')[0]} />
                              </div>
                              <div className="col-md-8">
                                <label className="doc-form-label">Time Slots (HH:MM)</label>
                                {healthcareAvailabilityTimeSlots.map((slot, idx) => (
                                  <div key={idx} className="input-group mb-2">
                                    <span className="input-group-text"><i className="bi bi-clock"></i></span>
                                    <input type="text" className="form-control doc-form-input" placeholder="09:00" value={slot} onChange={e => {
                                      const newSlots = [...healthcareAvailabilityTimeSlots];
                                      newSlots[idx] = e.target.value;
                                      setHealthcareAvailabilityTimeSlots(newSlots);
                                    }} />
                                    {healthcareAvailabilityTimeSlots.length > 1 && (
                                      <button className="btn btn-outline-danger" type="button" onClick={() => handleRemoveHealthcareTimeSlot(idx)}>
                                        <i className="bi bi-x-lg"></i>
                                      </button>
                                    )}
                                  </div>
                                ))}
                                <button className="btn btn-sm btn-outline-primary" type="button" onClick={handleAddHealthcareTimeSlot}>
                                  <i className="bi bi-plus-circle me-1"></i> Add Time Slot
                                </button>
                              </div>
                            </div>
                            <button className="btn btn-primary" type="button" onClick={handleAddHealthcareAvailability}>
                              <i className="bi bi-plus-circle me-2"></i> Add Availability
                            </button>
                          </div>
                        </div>

                        {healthcareFormData.availability.length > 0 && (
                          <div className="mt-4">
                            <h6 className="text-success"><i className="bi bi-check-circle-fill me-2"></i>Added Availability ({healthcareFormData.availability.length})</h6>
                            <div className="row g-3">
                              {healthcareFormData.availability.map((avail, idx) => (
                                <div key={idx} className="col-md-6">
                                  <div className="card doc-availability-item">
                                    <div className="card-body d-flex justify-content-between align-items-start">
                                      <div>
                                      ...
                                      <button className="btn btn-sm btn-outline-danger" type="button" onClick={() => handleRemoveHealthcareAvailability(idx)}>
                                        <i className="bi bi-trash"></i>
                                      </button>
                                    </div>
                                  </div>
