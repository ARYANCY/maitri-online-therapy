  ...
  // ---------------------------
    return (
      <div className="chatbot-container">
        ...
        {/* ----------------------------- */}
        {/* EXTRA INFO SECTIONS WITH MOTION */}
        {/* ----------------------------- */}
        <div className="chatbot-info-section">

          <div className="section fade-slide">
            <h2>Maitri AI Assistant</h2>
            <p>
              This assistant automatically understands your messages, analyses the context,  
              and responds in your <b>preferred language</b>.  
              Your language choice is saved in <b>localStorage</b>, so it stays even after closing the app.
            </p>
          </div>
          ...
          <div className="section fade-slide">
            <h3>Main Benefits</h3>
            <ul>
              <li>AI understands natural conversation and gives accurate responses.</li>
              <li>All text is processed to detect tasks automatically.</li>
              <li>Your Todo List updates dynamically based on your chats.</li>
              <li>Charts auto-refresh to show productivity trends.</li>
              <li>Smart session syncing across devices when logged in.</li>
              <li>Multi-language interface, remembered permanently.</li>
            </ul>
          </div>
          ...
          <div className="section fade-slide">
            ...
            <p>
              Just talk normally.  
              The system watches for tasks, schedules, reminders, goals,  
              and updates everything silently in the background.  
              No command format needed.
            </p>
          </div>

          <div className="section fade-slide">
            <h3>Why Language Preference Matters</h3>
            <p>
              Every answer adapts to your selected language.  
              Your interface, bot messages, and todo summaries follow the same language  
