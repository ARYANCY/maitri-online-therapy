...
exports.googleLogin = async (req, res) => {
  try {
    ...
    if (!user) user = await User.create({ email, name, googleId: payload.sub, avatar, password: "", isAdmin: false });
...
exports.requireAdmin = (req, res, next) => {
  ...
  req.user = { _id: req.session.userId, isAdmin: !!req.session.isAdmin };
  next();
};
